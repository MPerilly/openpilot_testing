...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    ret.wheelbase = 2.91  # in meters for KL-Cherokee 2020
    ret.steerRatio = 12.7 # KL-Cherokee
    ret.mass = 1721. + STD_CARGO_KG  # kg curb weight Chrysler 200 2016, works for KL-Cherokee
    ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kiBP = [[9., 20.], [9., 20.]] #Adding tuning from op v0.8.3 chryslers
    ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.15, 0.30], [0.03, 0.05]]
    ret.lateralTuning.pid.kf = 0.00006   # full torque for 10 deg at 80mph means 0.00007818594
    ret.steerActuatorDelay = 0.2 #KL-Cherokee
